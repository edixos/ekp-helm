...
|------------|------|---------|
| https://cloudnative-pg.github.io/charts | cnpg(cloudnative-pg) | 0.23.0 |
...
| cnpg.service.ipFamilyPolicy | string | `""` | Set the ip family policy to configure dual-stack see https://kubernetes.io/docs/concepts/services-networking/dual-stack/ |
