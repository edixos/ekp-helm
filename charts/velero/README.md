...
| https://vmware-tanzu.github.io/helm-charts | velero | 10.1.3 |
...
| velero.configuration.repositoryMaintenanceJob.repositoryConfigData.global | object | `{}` |  |
...
| velero.image.tag | string | `"v1.16.2"` |  |
