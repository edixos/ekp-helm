...
| velero.nodeAgent.disableHostPath | bool | `false` |  |
...
| velero.podDisruptionBudget.annotations | object | `{}` |  |
| velero.podDisruptionBudget.enabled | bool | `false` |  |
| velero.podDisruptionBudget.labels | object | `{}` |  |
| velero.podDisruptionBudget.maxUnavailable | string | `""` |  |
| velero.podDisruptionBudget.minAvailable | int | `1` |  |
