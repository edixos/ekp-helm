...
|------------|------|---------|
| https://kubernetes.github.io/ingress-nginx | ingressNginx(ingress-nginx) | 4.13.3 |
...
| ingressNginx.controller.admissionWebhooks.patch.image.digest | string | `"sha256:3d671cf20a35cd94efc5dcd484970779eb21e7938c98fbc3673693b8a117cf39"` |  |
...
| ingressNginx.controller.admissionWebhooks.patch.image.tag | string | `"v1.6.3"` |  |
...
| ingressNginx.controller.image.digest | string | `"sha256:1b044f6dcac3afbb59e05d98463f1dec6f3d3fb99940bc12ca5d80270358e3bd"` |  |
| ingressNginx.controller.image.digestChroot | string | `"sha256:27de15aea4ec7639f7cec6ae96bff11ce57bb1171040351a0b0eedf66655d0dd"` |  |
...
| ingressNginx.controller.image.tag | string | `"v1.13.3"` |  |
