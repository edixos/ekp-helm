...
|------------|------|---------|
| https://victoriametrics.github.io/helm-charts/ | vmstack(victoria-metrics-k8s-stack) | 0.93.0 |
...
| vmstack.syncJob.imagePullSecrets | list | `[]` | Image pull secrets for the sync-job Pod. Needed when `image.repository` points at a private registry. Falls back to `global.imagePullSecrets` when not set. |
