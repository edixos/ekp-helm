...
|------------|------|---------|
| https://charts.external-secrets.io | eso(external-secrets) | 0.20.2 |
...
| eso.livenessProbe.spec.httpGet.port | string | `"8082"` | Set this value to 8082 to active liveness probes. |
