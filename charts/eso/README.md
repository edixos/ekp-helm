...
| eso.livenessProbe.address | string | `""` | Address for liveness probe. |
...
| eso.livenessProbe.failureThreshold | int | `5` | Number of consecutive probe failures that should occur before considering the probe as failed. |
| eso.livenessProbe.httpGet | object | `{"path":"/healthz","port":"8082"}` | Handler for liveness probe. |
| eso.livenessProbe.httpGet.port | string | `"8082"` | Set this value to 8082 to active liveness probes. |
| eso.livenessProbe.initialDelaySeconds | int | `10` | Delay in seconds for the container to start before performing the initial probe. |
| eso.livenessProbe.periodSeconds | int | `10` | Period in seconds for K8s to start performing probes. |
| eso.livenessProbe.successThreshold | int | `1` | Number of successful probes to mark probe successful. |
| eso.livenessProbe.timeoutSeconds | int | `5` | Specify the maximum amount of time to wait for a probe to respond before considering it fails. |
