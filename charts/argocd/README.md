...
![Version: 0.1.14](https://img.shields.io/badge/Version-0.1.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.4.2](https://img.shields.io/badge/AppVersion-v3.4.2-informational?style=flat-square)
...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argocd(argo-cd) | 9.5.15 |
...
| argocd.redis.exporter.image.tag | string | `"v1.84.0"` | Tag to use for the redis-exporter |
