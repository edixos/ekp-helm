...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argocd(argo-cd) | 8.0.6 |
...
| argocd.dex.image.tag | string | `"v2.43.0"` | Dex image tag |
...
| argocd.redis.exporter.image.tag | string | `"v1.72.1"` | Tag to use for the redis-exporter |
