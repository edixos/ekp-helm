...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argocd(argo-cd) | 9.0.5 |
...
| argocd.redis-ha.image.tag | string | `"7.2.11-alpine"` | Redis tag # Do not upgrade to >= 7.4.0, otherwise you are no longer using an open source version of Redis |
...
| argocd.redis.exporter.image.tag | string | `"v1.79.0"` | Tag to use for the redis-exporter |
...
| argocd.redis.image.tag | string | `"7.2.11-alpine"` | Redis tag # Do not upgrade to >= 7.4.0, otherwise you are no longer using an open source version of Redis |
