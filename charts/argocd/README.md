...
![Version: 0.1.14](https://img.shields.io/badge/Version-0.1.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.4.5](https://img.shields.io/badge/AppVersion-v3.4.5-informational?style=flat-square)
...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argocd(argo-cd) | 10.2.1 |
...
| argocd.redis.exporter.image.tag | string | `"v1.88.0"` | Tag to use for the redis-exporter |
...
| argocd.redis.image.tag | string | `"8.2.3-alpine"` | Redis tag # Do not use 7.4.0 <= v < 8.0.0, otherwise you are no longer using an open source version of Redis |
