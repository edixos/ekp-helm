...
![Version: 0.1.14](https://img.shields.io/badge/Version-0.1.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.91.0](https://img.shields.io/badge/AppVersion-v0.91.0-informational?style=flat-square)
...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 86.2.3 |
...
| kubePrometheusStack.alertmanager.alertmanagerSpec.image.tag | string | `"v0.33.0"` |  |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.12.0-distroless"` |  |
...
| kubePrometheusStack.prometheusOperator.admissionWebhooks.patch.image.tag | string | `"1.8.3"` |  |
