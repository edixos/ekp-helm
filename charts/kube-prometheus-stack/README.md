...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 78.4.0 |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.7.1"` |  |
