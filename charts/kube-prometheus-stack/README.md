...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 86.2.2 |
...
| kubePrometheusStack.alertmanager.alertmanagerSpec.image.tag | string | `"v0.32.2"` |  |
