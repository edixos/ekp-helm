...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 79.11.0 |
...
| kubePrometheusStack.alertmanager.alertmanagerSpec.image.tag | string | `"v0.29.0"` |  |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.8.0"` |  |
...
| kubePrometheusStack.prometheusOperator.admissionWebhooks.patch.image.tag | string | `"v1.6.5"` |  |
