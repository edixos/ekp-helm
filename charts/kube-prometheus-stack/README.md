...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 80.13.0 |
...
| kubePrometheusStack.alertmanager.alertmanagerSpec.image.tag | string | `"v0.30.0"` |  |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.9.0"` |  |
