...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 77.12.0 |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.6.0"` |  |
...
| kubePrometheusStack.prometheusOperator.admissionWebhooks.patch.image.tag | string | `"v1.6.2"` |  |
