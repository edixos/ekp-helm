...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 87.16.1 |
...
| kubePrometheusStack.prometheusOperator.thanosImage.tag | string | `"v0.42.0"` |  |
...
| kubePrometheusStack.thanosRuler.thanosRulerSpec.image.tag | string | `"v0.42.0"` |  |
