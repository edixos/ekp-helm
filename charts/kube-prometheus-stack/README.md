...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 85.3.3 |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.11.3-distroless"` |  |
