...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 83.7.0 |
...
| kubePrometheusStack.alertmanager.alertmanagerSpec.image.tag | string | `"v0.32.0"` |  |
...
| kubePrometheusStack.prometheus.prometheusSpec.image.tag | string | `"v3.11.2"` |  |
...
| kubePrometheusStack.prometheusOperator.admissionWebhooks.patch.image.tag | string | `"1.8.1"` |  |
