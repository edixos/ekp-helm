...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | kubePrometheusStack(kube-prometheus-stack) | 75.11.0 |
...
| kubePrometheusStack.prometheusOperator.thanosImage.tag | string | `"v0.39.1"` |  |
...
| kubePrometheusStack.thanosRuler.thanosRulerSpec.image.tag | string | `"v0.39.1"` |  |
