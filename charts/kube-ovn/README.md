...
|------------|------|---------|
| https://kubeovn.github.io/kube-ovn/ | kube-ovn(kube-ovn) | v1.16.0 |
...
| kube-ovn.ovsOvn.upgrade | object | `{"enabled":true,"versionCompatibility":"25.03"}` | Upgrade logic for OVS/OVN. |
